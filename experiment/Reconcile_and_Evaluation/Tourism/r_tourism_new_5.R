...
G_opt <- npyLoad('./Reconcile_and_Evaluation/Tourism/Tourism_ETS_Regularization_G_indep_optuna_5.npy')
...
write.csv(res_energyscore,'.\\Evaluation_Result_new\\Energy_Score\\Tourism_ETS_5.csv',row.names=FALSE)
write.csv(res_crps,'.\\Evaluation_Result_new\\CRPS\\Tourism_ETS_5.csv',row.names=FALSE)
write.csv(res_variogramscore,'.\\Evaluation_Result_new\\Variogram_Score\\Tourism_ETS_5.csv',row.names=FALSE)
