...
if __name__ == '__main__':
    ...
    for iter_time in range(1,2):
        ...
        # np.save('./Reconcile_and_Evaluation/Tourism/Tourism_ETS_Regularization_min_G_indep_optuna_5.npy',G_list[ind])
        # np.save('./Reconcile_and_Evaluation/Tourism/Tourism_ETS_Reluarization_loss_indep_optuna_5.npy',loss)
        np.save(f'./Reconcile_and_Evaluation/Tourism/src/Tourism_ETS_5_{iter_time}.npy',G)
        ...
        # plt.xlabel('迭代次数')
        # plt.ylabel('能量得分')
        # plt.savefig('./Plot_new/Tourism/Tourism_ETS_indep_5.png')
        # plt.show()