...
ind<-match(c("D6ACT","D1ACT","D1QLD","D1SAS","D1TAS"),colname)

# Read base forecasts
fc<-fromJSON('./Base_Forecasts/Labour/labour.json')
for(i in 1:57){
...
basis_lis<-forecast.basis_series(S,immu_set=c(50, 10, 13, 14, 15))
...
write_json(json_object, "./Reconcile_and_Evaluation/Labour/labour_tranformed_Smat_5.json", pretty = TRUE)
write_json(new_ind, "./Reconcile_and_Evaluation/Labour/labour_tranformed_newindex_5.json", pretty = TRUE)
write_json(json_object, "./Reconcile_and_Evaluation/Labour/labour_tranformed_Smat.json", pretty = TRUE)
# write_json(new_ind, "./Reconcile_and_Evaluation/Labour/labour_tranformed_newindex_5.json", pretty = TRUE)
