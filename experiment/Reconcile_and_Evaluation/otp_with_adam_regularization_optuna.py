...
def objective(trial):
    ...
    l1_lambda = trial.suggest_categorical("l1_lambda",[1000,10000])
    l2_lambda = trial.suggest_categorical("l2_lambda",[1000,10000])
...
if __name__ == '__main__':
    ...
    search_space = {'l1_lambda':[1000,10000],
                    'l2_lambda':[1000,10000]}
    ...
    with open('regularization_params.json','w') as file:
