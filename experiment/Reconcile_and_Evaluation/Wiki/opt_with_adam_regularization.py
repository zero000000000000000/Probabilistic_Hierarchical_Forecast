...
if __name__ == '__main__':
    ...
    np.save('./Reconcile_and_Evaluation/Wiki/Wiki_ARIMA_Regularization_min_G_indep_optuna.npy',G_list[ind])
    ...
    plt.title('Wiki::ARIMA 能量得分迭代图')
    plt.xlabel('迭代次数')
    plt.ylabel('能量得分')
    plt.savefig('./Plot_new/Wiki/Wiki_ARIMA_indep.png')
    plt.show()
