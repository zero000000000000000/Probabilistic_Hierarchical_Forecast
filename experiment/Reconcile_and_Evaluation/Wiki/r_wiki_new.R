...
# Read base forecasts
fc<-fromJSON('./Reconcile_and_Evaluation/Wiki/Wiki_out_process.json')
# fc<-fc[[1]]
for(i in 1:evalN){
...
write.csv(res_crps,'.\\Evaluation_Result_new\\CRPS\\Wiki_arima.csv',row.names=FALSE)
write.csv(res_variogramscore,'.\\Evaluation_Result_new\\Variogram_Score\\Wiki_arima.csv',row.names=FALSE)
