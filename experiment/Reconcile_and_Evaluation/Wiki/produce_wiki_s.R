...
colname<-colnames(data[,-c(1)])
ind<-match(c("fr_MOB_AAG_030","de_DES_AAG_131","fr_MOB_AAG_121","ja_AAC_AAG_047","zh_AAC_SPD_096"),colname)

# Read base forecasts
fc<-fromJSON('./Base_Forecasts/Wiki/Wiki.json')
for(i in 1:199){
...
write_json(json_object, "./Reconcile_and_Evaluation/Wiki/Wiki_tranformed_Smat.json", pretty = TRUE)
write_json(new_ind, "./Reconcile_and_Evaluation/Wiki/Wiki_tranformed_newindex.json", pretty = TRUE)
