...
xxs<-xs[new_index,]
yy<-y[new_index,]
optv[i]<-energy_score(yy,S1%*%G_opt%*%xx,S1%*%G_opt%*%xxs)
optcv[((i-1)*M+1):(i*M)]<-crps(yy,S1%*%G_opt%*%xx,S1%*%G_opt%*%xxs)
opt_vsv[i]<-variogram_score(yy,S1%*%G_opt%*%xx)
